...
/*
void dispPkmIco(int id)
{
  char file[15];
  sprintf(file,"icn/%d.bmp",id); // charge new pkm
  Serial.println(file);
  bmpDraw(file, 100, 100); 
}
*/
...
void bmpDraw(char *filename, uint8_t x, uint8_t y) {
  ...
  uint8_t  sdbuffer[BUFFPIXEL]; // pixel buffer (2 pixel per uint8_t)
